...
echo "  ${INSTANCE_URL}/now/nav/ui/classic/params/target/sn_devops_test_result_list.do"
echo ""
echo -e "${GREEN}Security Results:${NC}"
echo "  ${INSTANCE_URL}/now/nav/ui/classic/params/target/sn_devops_security_result_list.do"
echo ""
echo -e "${GREEN}Work Items:${NC}"
echo "  ${INSTANCE_URL}/now/nav/ui/classic/params/target/sn_devops_work_item_list.do"
echo ""
echo -e "${GREEN}CMDB - EKS Clusters:${NC}"
echo "  ${INSTANCE_URL}/now/nav/ui/classic/params/target/u_eks_cluster_list.do"
echo ""
echo -e "${GREEN}CMDB - Microservices:${NC}"
echo "  ${INSTANCE_URL}/now/nav/ui/classic/params/target/u_microservice_list.do"
echo ""
echo -e "${GREEN}All Apps / DevOps Menu:${NC}"
echo "  ${INSTANCE_URL}/\$pa_dashboard.do"
echo "  (Navigate to 'DevOps' app from here)"
echo ""
